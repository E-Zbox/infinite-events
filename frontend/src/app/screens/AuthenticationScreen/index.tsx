...
import {
  ...
  SubTitle,
  TextInput,
} from "../../styles/AuthenticationScreen/index.styles";
...
const AuthenticationScreen = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (showSignInFormState) {
      ...
      setUserState({ isGuest: false, signedIn: true, socket, token, username });
    } else {
      setFormState((prevState) => ({ ...prevState, loading: true }));
    ...
    <MainAuthScreen>
      ...
      <MainForm>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <OrContainer>
            <OrLine></OrLine>
            <OrText>Or Continue As</OrText>
            <OrLine></OrLine>
          </OrContainer>
          <GuestLogin onClick={handleGuestLogin}>Guest</GuestLogin>
        </Form>
      </MainForm>
    </MainAuthScreen>
  );
